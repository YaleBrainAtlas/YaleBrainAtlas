...
OV.NavigatorInfoPanel = class
{
    ...
    FillWithModelInfo (usedMaterials, callbacks)
    {
        ...
        let materialsText = 'Colors (' + materialItems.length + ')';
...
OV.Navigator = class
{
    ...
    Resize ()
    {
        let titleHeight = this.titleDiv.outerHeight (true) * 0.7;
        let infoHeight = this.infoDiv.outerHeight (true) * 0.7;
        let height = this.parentDiv.height () * 0.7;
        this.treeDiv.outerHeight (height - infoHeight - titleHeight, true)*0.7;
    }
    ...
    FillTree (importResult)
    {
        ...
        let materialsItem = new OV.TreeViewGroupItem ('Colors', 'assets/images/tree/materials.svg');
        ...
        let meshesItem = new OV.TreeViewGroupItem ('Parcels', 'assets/images/tree/meshes.svg');
